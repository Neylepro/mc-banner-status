...
function loadMCBanner(){ //send request and kickstart the rest of the banner
    ...
    getMC.open("GET", "https://api.mcsrvstat.us/2/de3.halexnodes.xyz:25564", true);
    getMC.send();
}
